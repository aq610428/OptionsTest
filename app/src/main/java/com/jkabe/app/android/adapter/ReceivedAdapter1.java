 ...
 */
public class ReceivedAdapter1 extends AutoRVAdapter {
    private List<OrderInfo> orderInfos;
    private ReceivedFragment fragment;

    public ReceivedAdapter1(ReceivedFragment fragment, List<OrderInfo> list) {
    ...
    public void onBindViewHolder(ViewHolder vh, int position) {
        ...
        vh.getTextView(R.id.text_cancel).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                fragment.quryDeil(orderInfo.getId());
            }
        });
        vh.getTextView(R.id.text_mobile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SystemTools.callPhone(fragment.getContext(),orderInfo.getMobile());
            }
        });
