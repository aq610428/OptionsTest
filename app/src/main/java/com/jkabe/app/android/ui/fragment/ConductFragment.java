...
import com.jkabe.app.android.adapter.ReceivedAdapter;
 ...
 * @name:进行中
 */
public class ConductFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener, NetWorkListener {
    ...
    private void qury() {
        String sign = "memberId=" + SaveUtils.getSaveInfo().getId() + "&partnerid=" + Constants.PARTNERID + "&status=2" + Constants.SECREKEY;
