...
public class CircleProgressBar extends AppCompatImageView {
    ...
    private static final int KEY_SHADOW_COLOR = 0x00000000;
    private static final int FILL_SHADOW_COLOR = 0x00000000;
    // PX
    ...
    private int[] mColors = new int[]{Color.parseColor("#FF000000")};
