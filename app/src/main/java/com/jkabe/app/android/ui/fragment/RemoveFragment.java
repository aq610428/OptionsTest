 ...
 * @name:我的车
 */
public class RemoveFragment extends BaseFragment implements OnRefreshListener, OnLoadMoreListener, NetWorkListener {
    ...
    private void qury() {
        String sign = "memberId=" + SaveUtils.getSaveInfo().getId() + "&partnerid=" + Constants.PARTNERID + "&status=0" + Constants.SECREKEY;
