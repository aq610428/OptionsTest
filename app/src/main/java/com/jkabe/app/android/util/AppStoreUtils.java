...
public class AppStoreUtils {
    ...
    public static Intent getAppStoreIntent() {
        return getAppStoreIntent(BaseApplication.getInstance().getPackageName(), false);
    }
    ...
    public static Intent getAppStoreIntent(boolean isIncludeGooglePlayStore) {
        return getAppStoreIntent(BaseApplication.getInstance().getPackageName(), isIncludeGooglePlayStore);
    }
    ...
    public static Intent getAppStoreIntent(final String packageName, boolean isIncludeGooglePlayStore) {
        ...
        List<ResolveInfo> resolveInfos = BaseApplication.getInstance().getPackageManager()
