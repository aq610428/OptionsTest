...
import com.jkabe.app.box.adapter.MainAdapter;
 ...
 * @name:行程数据区块
 */
public class MaintenanceActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener, NetWorkListener {
    ...
    private List<EnceInfo> travrts = new ArrayList<>();
    private MainAdapter tripAdapter;
    ...
    protected void initView() {
        ...
        title_text_tv.setText("维保数据区块");
        mNoDataView.textView.setText("暂无维保数据区块");
    }
    ...
    public void query() {
        ...
        okHttpModel.get(Api.RESET_TOKEN_DATA, params, Api.RESET_TOKEN_TRIP_ID, this);
    }
            ...
            if (Constants.SUCESSCODE.equals(commonality.getStatusCode())) {
                switch (id) {
                    case Api.RESET_TOKEN_TRIP_ID:
                        List<EnceInfo> travrts = JsonParse.getCarSafeVOJson2(object);
    ...
    private void setAdapter(List<EnceInfo> voList) {
        ...
        if (!isRefresh) {
            ...
            tripAdapter = new MainAdapter(this, travrts);
        ...
        tripAdapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MaintenanceActivity.this, MainDeilActivity.class);
