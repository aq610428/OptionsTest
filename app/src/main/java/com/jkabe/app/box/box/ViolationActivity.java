...
import com.jkabe.app.box.adapter.InsurAdapter1;
 ...
 * @name:行程数据区块
 */
public class ViolationActivity extends BaseActivity implements OnRefreshListener, OnLoadMoreListener, NetWorkListener {
    ...
    private List<Violation> travrts = new ArrayList<>();
    private InsurAdapter1 tripAdapter;
    ...
    protected void initView() {
        ...
        title_text_tv.setText("违章数据区块");
        mNoDataView.textView.setText("暂无违章数据区块");
    }
    ...
    public void query() {
        ...
        okHttpModel.get(Api.RESET_TOKEN_VIOLATE, params, Api.RESET_TOKEN_TRIP_ID, this);
    }
            ...
            if (Constants.SUCESSCODE.equals(commonality.getStatusCode())) {
                switch (id) {
                    case Api.RESET_TOKEN_TRIP_ID:
                        List<Violation> travrts = JsonParse.getViolationJson2(object);
    ...
    private void setAdapter(List<Violation> voList) {
        ...
        if (!isRefresh) {
            ...
            tripAdapter = new InsurAdapter1(this, travrts);
        ...
        tripAdapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ViolationActivity.this, ViolationDeilActivity.class);
