 ...
 * @name:TabFragment1
 */
public class TabFragment2 extends BaseFragment implements NetWorkListener, View.OnClickListener, OnRefreshListener {
    ...
    private void initView() {
        ...
        TypefaceUtil.setTextType(getContext(), "DINOT-Bold.ttf", text_dig);
        TypefaceUtil.setTextType(getContext(), "DINOT-Bold.ttf", text_work);
