...
import com.jkabe.app.box.ui.fragment.OreLostragment;
 ...
 *
 */
public class MainActivity1 extends BaseActivity1 implements NetWorkListener {
    public Class fragments[] = {CarFragment.class, LeftFragment.class,  CartFragment.class,MeFragment.class};
    public int drawables[] = {R.drawable.book_drawable, R.drawable.shelf_drawable, R.drawable.chosen_cart, R.drawable.me_drawable};
    public String textviewArray[] = {"我的车", "车生活", "购物车", "我的"};
    ...
    public void applyPermission() {
        AndPermission.with(this).runtime().permission(Permission.WRITE_EXTERNAL_STORAGE,Permission.READ_EXTERNAL_STORAGE)
                ...
                .onDenied(new Action<List<String>>() {
                    @Override
                    public void onAction(List<String> permissions) {
                        if (AndPermission.hasAlwaysDeniedPermission(MainActivity1.this, permissions)) {
                            showSettingDialog(MainActivity1.this, permissions);
                        }
                    }
                })
                .start();
